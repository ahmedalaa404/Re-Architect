// =============================================================================
// Hiring Page Language Switching JavaScript
// =============================================================================

class HiringLanguageManager {
  constructor() {
...
document.addEventListener('DOMContentLoaded', () => {
  // Check if we're on the hiring page
  const hiringPage = document.querySelector('.hiring-hero');
  
  if (hiringPage) {
    window.hiringLanguageManager = new HiringLanguageManager();
  }
});

// Export for manual initialization
export function initializeHiringLanguage() {
  return new HiringLanguageManager();
}

// Utility functions for manual language switching
export function switchToEnglish() {
  if (window.hiringLanguageManager) {
    window.hiringLanguageManager.switchLanguage('en');
  }
}

export function switchToArabic() {
  if (window.hiringLanguageManager) {
    window.hiringLanguageManager.switchLanguage('ar');
  }
} 