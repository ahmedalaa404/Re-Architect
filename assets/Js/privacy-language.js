// =============================================================================
// Privacy Policy Language Switching JavaScript
// =============================================================================
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const privacyPage = document.querySelector('.privacy-hero');
  
  if (privacyPage) {
    window.privacyLanguageManager = new PrivacyLanguageManager();
  }
});

// Export for manual initialization
export function initializePrivacyLanguage() {
  return new PrivacyLanguageManager();
}

// Utility functions for manual language switching
export function switchToEnglish() {
  if (window.privacyLanguageManager) {
    window.privacyLanguageManager.switchLanguage('en');
  }
}

export function switchToArabic() {
  if (window.privacyLanguageManager) {
    window.privacyLanguageManager.switchLanguage('ar');
  }
} 