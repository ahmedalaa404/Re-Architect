// =============================================================================
// News Language Switching JavaScript
// =============================================================================

class NewsLanguageManager {
  constructor() {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (newsSection || newsDetailsContent) {
    window.newsLanguageManager = new NewsLanguageManager();
  }
});

// Export for manual initialization
export function initializeNewsLanguage() {
  return new NewsLanguageManager();
}

// Utility functions for manual language switching
export function switchToEnglish() {
  if (window.newsLanguageManager) {
    window.newsLanguageManager.switchLanguage('en');
  }
}

export function switchToArabic() {
  if (window.newsLanguageManager) {
    window.newsLanguageManager.switchLanguage('ar');
  }
} 